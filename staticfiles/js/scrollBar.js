	...
	"use strict";
		...
		$.extend( Plugin.prototype, {
			...
			addScrollbar: function() {
                                ...
                                this.scollbarContainer = $(`<div class='` + this.settings.scrollbarContainerClass + `' id="sb-scrollbar--container${control_current_screen}"/>`); 
                                
                                this.scrollBar = $(`<div class='` + this.settings.scrollBarClass + `' id="sb-scrollbar${control_current_screen}"/>`);
